...
def build_win_cursor_theme(
    ...
    `cursor_sizes` is pixel size for generating cursor(basically in `integer array`)
    ...
    with TemporaryDirectory() as configs:
        configsgen(image_dir, cursor_sizes, hotspots, out_dir=configs, delay=delay)
