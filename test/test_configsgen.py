...
class TestConfigsgen(unittest.TestCase):
    ...
    def assert_image_size(self, img_path: str, size: int):
        ...
        self.assertTupleEqual(mock_resize_image_instace.size, (size, size))
    ...
    def test_get_cursor_list(self):
        ...
        self.assertEqual(
            mock_animated_list,
            [
                ["mock_animated_1-01.png", "mock_animated_1-02.png"],
    ...
    def test_resize_cursor(self):
        ...
        result_coordinates_tuple = configsgen.resize_cursor(
            ...
            size=self.mock_size,
            imgs_dir=self.mock_images_path,
        ...
        self.assertTupleEqual(
            result_coordinates_tuple, (self.mock_size / 2, self.mock_size / 2)
        )
